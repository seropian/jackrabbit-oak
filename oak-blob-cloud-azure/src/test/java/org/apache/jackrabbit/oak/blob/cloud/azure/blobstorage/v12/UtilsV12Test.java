...
public class UtilsV12Test {
    ...
    @Test
    public void createProxyOptions_strings_hostAndPortSet_returnsProxyOptions() {
        assertNotNull(UtilsV12.createProxyOptions("proxy.example.com", "8080"));
    }

    @Test
    public void createProxyOptions_strings_nullHost_returnsNull() {
        assertNull(UtilsV12.createProxyOptions(null, "8080"));
    }

    @Test
    public void createProxyOptions_strings_nullPort_returnsNull() {
        assertNull(UtilsV12.createProxyOptions("proxy.example.com", null));
    }

    @Test
    public void createProxyOptions_strings_emptyHost_returnsNull() {
        assertNull(UtilsV12.createProxyOptions("", "8080"));
    }

    @Test
    public void createProxyOptions_strings_bothNull_returnsNull() {
        assertNull(UtilsV12.createProxyOptions(null, null));
    }
